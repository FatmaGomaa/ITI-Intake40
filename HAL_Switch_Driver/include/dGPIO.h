...
#define PORT_A		                            ((volatile void * )0x40010800)
#define PORT_B		                            ((volatile void * )0x40010C00)
#define PORT_C		                            ((volatile void * )0x40011000)
/*
#define DPIN_0									0
#define DPIN_1									1
#define DPIN_2									2
 ...
 * and it returns Standard error whether the function did it job or failed*/
STD_ERROR GPIO_STD_ERROR_writePin(void* PORT, u32 PIN, u8 OutputValue);
 ...
 * and it returns Standard error whether the function did it job or failed*/
STD_ERROR GPIO_STD_ERROR_writePort(u32* PORT, u8 OutputValue);

/*The function returns the value of the input pin on the specified PORT
 * 1. PORT in range PORT_A, PORT_B, PORT_C
 * 2. PIN in range PIN_0 .... PIN_15*/
u8 GPIO_u8getPinValue(void* PORT, u32 PIN);
